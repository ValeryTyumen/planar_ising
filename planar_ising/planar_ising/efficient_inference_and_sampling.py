...
from .partial_spin_configuration import partial_spin_configuration_nb_type, PartialSpinConfiguration
...
from ..planar_graph import planar_graph_nb_type, triangulator, planar_graph_constructor
from ..sparse_lu import sparse_lu


class EfficientInferenceAndSampling:
    """
    A class performing efficient inference/sampling in planar zero-field Ising models.
    """
    ...
    def compute_log_partition_function(self):
        ...
        ising_model, graph_edges_mapping, expanded_dual_graph, weights, \
    ...
    def prepare_for_sampling(self):
        ...
        self._ising_model, self._graph_edges_mapping, \
